...
class nyewacontroller extends Controller
{
    /**
    ...
    {   
        ...
        $diskon = 0.1;
        $dp = 1000000;
        return view("user.nyewa", compact('sewa', 'dp', 'diskon'));
    }
    ...
    {   
        ...
        $diskon = 0.1;
        $dp = 1000000;
        return view("user.create", compact('sewa', 'dp', 'diskon'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user')->with("success", "Data berhasil di simpan dengan baik");
    }
    ...
    {
        $sewa = Sewa::find($id);
        return view('user.edit', compact('sewa'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('user')->with('success', 'Data penyewaan berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if($sewa){
            $sewa->delete();
            return redirect()->route('user')->with("success", 'Data penyewaan berhasil di delete');
        }else{
            return redirect()->route('user')->with("error", "Data tidak berhasil terhapus");
        }
    }
}